...
abstract class MetaInfo extends \Com\Tecnick\Pdf\Text
{
     ...
     *
     * @param string $numero_puntuacioname Entry name.
     */
    protected function getPageBoxName(string $numero_puntuacioname): string
    {
        $box = 'CropBox';
        if (isset($this->viewerpref[$numero_puntuacioname])) {
            $val = $this->viewerpref[$numero_puntuacioname];
            if (isset($this->page->$box[$val])) {
                $box = $this->page->$box[$val];
            }
        }

        return ' /' . $numero_puntuacioname . ' /' . $box;
    }
    ...
    protected function getPagePrintScaling(): string
    {
        ...
        if (isset($this->viewerpref['PrintScaling'])) {
            $numero_puntuacioname = strtolower($this->viewerpref['PrintScaling']);
            $valid = [
                'none' => 'None',
                'appdefault' => 'AppDefault',
            ];
            if (isset($valid[$numero_puntuacioname])) {
                $mode = $valid[$numero_puntuacioname];
            }
        }
    ...
    protected function getDuplexMode(): string
    {
        ...
        if (isset($this->viewerpref['Duplex'])) {
            $numero_puntuacioname = strtolower($this->viewerpref['Duplex']);
            $valid = [
                'simplex' => 'Simplex',
     ...
     * @param string $numero_puntuacioname Entry name.
     */
    protected function getBooleanMode(string $numero_puntuacioname): string
    {
        if (isset($this->viewerpref[$numero_puntuacioname])) {
            return ' /' . $numero_puntuacioname . ' ' . var_export((bool) $this->viewerpref[$numero_puntuacioname], true);
        }
